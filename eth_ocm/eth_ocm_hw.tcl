...
# Fri Jun 06 14:42:26 MDT 2008
# DO NOT MODIFY


# +-----------------------------------
# | 
# | eth_ocm "OpenCores 10/100 Ethernet MAC Avalon" v8.0
# | Jakob Jones 2008.06.06.14:42:26
# | 
# | 
# | C:/altera/72/ip/sopc_builder_ip/eth_ocm/eth_ocm.v
# | 
# |    ./eth_ocm.v syn, sim
# | 
# +-----------------------------------
...
# | parameters
# | 
add_parameter TOTAL_DESCRIPTORS int 128
...
add_parameter TX_FIFO_SIZE_IN_BYTES int 128
...
add_parameter RX_FIFO_SIZE_IN_BYTES int 4096
...
add_interface_port clk av_clk clk Input 1
add_interface_port clk av_reset reset Input 1
# | 
# +-----------------------------------
...
set_interface_property global ASSOCIATED_CLOCK clk
...
set_interface_property control_port addressSpan 1024
...
set_interface_property control_port ASSOCIATED_CLOCK clk
...
set_interface_property control_port_irq ASSOCIATED_CLOCK clk
...
set_interface_property rx_master ASSOCIATED_CLOCK clk
...
set_interface_property tx_master ASSOCIATED_CLOCK clk
